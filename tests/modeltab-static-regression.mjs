...
check("evidence receipt preserves input accessibility evidence", includesAll(files.evidenceReceipt, ["Input Accessibility Evidence", "keyboard only", "mouse/pointer only", "touch only", "platform-limited input only", "No critical workflow may require", "platform text-entry support", "Single input operation"]));
check("evidence receipt preserves design language evidence", includesAll(files.evidenceReceipt, ["Design Language Evidence", "Signature Ecosystem Evidence", "shared `shfqrkhn` ecosystem", "Signature ecosystem fit", "modern minimalist", "Uiverse", "Open Props", "Design language/UI safety", "browser JS popups", "component overlap"]));
...
check("evidence receipt preserves mission-critical reliability evidence", includesAll(files.evidenceReceipt, ["Mission-Critical Reliability Evidence", "self-checking", "crash-recoverable", "state-explicit", "TDD/SDD", "Autonomous AI-assisted development", "Mission-critical reliability"]));
...
check("handoff preserves reliability truth", includesAll(files.handoff, ["Reliability truth", "self-checking", "crash-recoverable", "state-explicit", "TDD/SDD-backed", "remove complexity"]));
check("handoff preserves design truth", includesAll(files.handoff, ["Ecosystem truth", "shared signature design system", "Design truth", "Single input truth", "modern minimalist", "MIT UI libraries/resources", "browser JS popups", "arbitrary component copy-paste", "combined input-mode path"]));
