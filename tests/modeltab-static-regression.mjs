...
check("evidence receipt preserves design language evidence", includesAll(files.evidenceReceipt, ["Design Language Evidence", "modern minimalist", "Uiverse", "Open Props", "Design language/UI safety", "browser JS popups", "component overlap"]));
...
check("handoff preserves design truth", includesAll(files.handoff, ["Design truth", "Single input truth", "modern minimalist", "MIT UI libraries/resources", "browser JS popups", "arbitrary component copy-paste", "combined input-mode path"]));
