...
check("evidence receipt preserves safe-to-publish receipt", includesAll(files.evidenceReceipt, ["Safe-To-Publish Receipt", "clean synced tree", "no GitHub Releases", "no protected tracked paths", "no open security/dependabot alerts", "remaining risks"]));
