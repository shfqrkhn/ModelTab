...
const PROVIDER_PRESETS = [
  ...
  },
  {
    ...
    category: "Local",
    testingTier: "local/free",
    sourceLabel: "OpenAI API compatibility target",
    sourceUrl: "https://developers.openai.com/api/reference/overview",
    setupUrl: "https://developers.openai.com/api/reference/overview",
    costNote: "Runs against a user-controlled local/LAN endpoint that implements an OpenAI-compatible API; no cloud prompt leaves the device through ModelTab unless the user points it at a cloud URL.",
    type: "openai",
